...
#########################################################
                ...
                rnp.fill_hist(hist[sample][tree_name]['cos_lep_S'], np.concatenate(cos_lep_s), np.concatenate([evt_weight, evt_weight])) 
                rnp.fill_hist(hist[sample][tree_name]['dphi_lep_S'], np.concatenate(dphi_lep_s), np.concatenate([evt_weight, evt_weight])) 
